...
### Ускорение
Сравним скорость выполнения байт-кода и машинного кода. В таблице приведены результаты прогонки программы `1000000` раз. Соревноваться будем с флагом `-O2`. Я предпочитаю именно его, так как он гарантирует надежность оптимизаций.
...
## Заключение
Из результатов видно, что мы превзошли флаг `-O2` в 43.7 раз! Значит, наша работа была проделана не зря :)
